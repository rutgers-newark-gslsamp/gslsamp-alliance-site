    ...
    <>
      ...
      <div className="flex justify-center">
        <div className="m-5 grid sm:grid-cols-2 w-[50rem] justify-items-center">
          <a href="/phd-2020.pdf" download="phd_program_applicant_checklist.pdf" className="resource bg-gradient-to-t from-rutgers_red to-dark_rutgers_red border-dark_rutgers_red shadow-md">
